...
class Memo {
  ...
  String content;
  bool isPinned;
  DateTime? updateTime; // updateTime can get value null

  Map toJson() {
    return {
      'content': content,
      'isPinned': isPinned,
      'updateTime': updateTime?.toIso8601String(), // datetime foramt ISO8601
    };
  }
  ...
  factory Memo.fromJson(json) {
    return Memo(
      ...
      isPinned: json['isPinned'] ?? false, // null일 경우 false
...
class MemoService extends ChangeNotifier {
  ...
  updateContentMemo({required int index, required String content}) {
